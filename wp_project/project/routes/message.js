 ...
 * @access Private
 */
router.get('/:chatId', protectedRoute.protectedRoute, async (req, res) => {
  try {
 ...
 * @access Private
 */
router.delete('/:messageId', protectedRoute.protectedRoute, async (req, res) => {
  try {
 ...
 * @access Private
 */
router.post('/status', protectedRoute.protectedRoute, async (req, res) => {
  try {
 ...
 * @access Private
 */
router.post('/', protectedRoute.protectedRoute, async (req, res) => {
  try {
